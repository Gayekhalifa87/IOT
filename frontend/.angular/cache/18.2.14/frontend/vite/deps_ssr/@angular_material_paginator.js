...
import {
  ...
  Overlay,
  OverlayModule
} from "./chunk-J22Q2WE6.js";
import {
  CdkScrollableModule,
  ScrollDispatcher,
  SelectionModel,
  ViewportRuler
} from "./chunk-KZFWYII4.js";
import {
  animate,
  animateChild,
  query,
...
var MatSelect = class _MatSelect {
  ...
  _panelDoneAnimatingStream = new import_rxjs3.Subject();
...
var TooltipComponent = class _TooltipComponent {
  ...
  _onHide = new import_rxjs4.Subject();
...
var MatPaginatorIntl = class _MatPaginatorIntl {
   ...
   */
  changes = new import_rxjs5.Subject();
...
var MatPaginator = class _MatPaginator {
  ...
  _initializedStream = new import_rxjs5.ReplaySubject(1);
  /**
